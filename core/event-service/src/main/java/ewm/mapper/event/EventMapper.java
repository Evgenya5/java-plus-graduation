...
public class EventMapper {
    ...
    public EventFullDto toFullDto(Event event, int confirmedRequests, long views, UserShortDto userShortDto) {
    ...
    public EventShortDto toShortDto(Event event, int confirmedRequests, long views, UserShortDto userShortDto) {
